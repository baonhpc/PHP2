        ...
        <div class="wrapbox-content-page">
          <div class="content-page ">
            <p>Chuỗi nhà thuốc uy tín hàng đầu Việt Nam
              Với hơn 12 năm hoạt động, Medical health care tự hào là người bạn đồng hành tin cậy của hàng triệu người dân Việt Nam trên hành trình nâng cao chất lượng sức khỏe. Hệ thống gần 1000 nhà thuốc đạt chuẩn GPP trên toàn quốc trải dài 40 tỉnh thành, cùng đội ngũ gần 5000 Dược sĩ, Medical health care mang đến dịch vụ chăm sóc sức khỏe tận tâm và trải nghiệm mua sắm tiện lợi cho mọi khách hàng.</p>
            <h3>Sản phẩm chính hãng, giá tốt </h3>
            <p>Medical health care cam kết cung cấp sản phẩm chính hãng, đa dạng từ thuốc cho các nhóm bệnh: Tiểu Đường, Huyết Áp, Mỡ Máu, Tiêu Hóa, Hô Hấp,… đến thực phẩm chức năng, sản phẩm chăm sóc sức khỏe, sắc đẹp, thiết bị y tế thuộc các thương hiệu hàng đầu thế giới như: Abbott, GSK, Sanofi, Astrazeneca, Pfizer, Mega Lifesciences, Goodlife, L’oreal, Durex,… và các thương hiệu uy tín tại Việt Nam như Dược Hậu Giang, Nam Hà,… Bên cạnh đó, chúng tôi luôn chú trọng bảo quản sản phẩm trong điều kiện tốt nhất, đảm bảo chất lượng đến tay người tiêu dùng.</p>
            <h3>Dược sĩ tận tâm, tư vấn chuyên nghiệp</h3>
            <p>Đội ngũ Dược sĩ Medical health care được đào tạo bài bản, có chuyên môn cao và giàu kinh nghiệm. Luôn đặt lợi ích khách hàng lên hàng đầu, sẵn sàng tư vấn, giải đáp thắc mắc và hướng dẫn sử dụng sản phẩm hiệu quả, an toàn.</p>
            <h3>Mua sắm tiện lợi, giao hàng nhanh chóng</h3>
            <p>Thấu hiểu nhu cầu đa dạng của khách hàng, Medical health care mang đến hệ thống mua sắm đa kênh vô cùng tiện lợi:</p>
            <ul style = "margin-left: 40px;">
              <li>Mua trực tiếp tại nhà thuốc: Hệ thống gần 1000 nhà thuốc Medical health care trải dài 40 tỉnh thành.</li>
              <li>Mua hàng trực tuyến: Truy cập trang https://www.pharmacity.vn/ hoặc ứng dụng Medical health care.</li>
            ...
            <p>Medical health care triển khai chương trình P-Thành Viên hấp dẫn. Mỗi giao dịch mua sắm, khách hàng đều được tích điểm và có thể sử dụng điểm để trừ tiền cho các lần mua sau. Ngoài ra, Medical health care luôn có các chương trình khuyến mãi, ưu đãi dành riêng cho khách hàng thân thiết.</p>
            <h3>Lựa chọn Medical health care, lựa chọn an tâm cho sức khỏe bản thân và gia đình!</h3>
          </div>
        </div>
      </div>
    </div>
