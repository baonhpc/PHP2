                    ...
                    <div class="product-gallery__thumbs thumb-fix">
                      ...
                      <div class="product-gallery__thumb  active" id="imgg1">
                        <a class="product-gallery__thumb-placeholder" href="javascript:void(0);"
                          data-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/1.jpg" data-zoom-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/1.jpg">
                          <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/1.jpg" data-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/1.jpg"
                      ...
                      <div class="product-gallery__thumb " id="imgg2">
                        <a class="product-gallery__thumb-placeholder" href="javascript:void(0);"
                          data-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/5.jpg" data-zoom-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/5.jpg">
                          <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/5.jpg" data-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/5.jpg"
                            alt="Nike Air Max 90 Essential" grape="">
                        </a>
                      </div>
                      ...
                      <div class="product-gallery__thumb " id="imgg3">
                        <a class="product-gallery__thumb-placeholder" href="javascript:void(0);"
                          data-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/2.jpg" data-zoom-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/2.jpg">
                          <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/2.jpg" data-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/2.jpg"
                            alt="Nike Air Max 90 Essential" grape="">
                        </a>
                      </div>
                      ...
                      <div class="product-gallery__thumb " id="imgg4">
                        <a class="product-gallery__thumb-placeholder" href="javascript:void(0);"
                          data-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/4.jpg" data-zoom-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/4.jpg">
                          <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/4.jpg" data-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/4.jpg"
                            alt="Nike Air Max 90 Essential" grape="">
                        </a>
                      </div>
                      ...
                      <div class="product-gallery__thumb " id="imgg7">
                        <a class="product-gallery__thumb-placeholder" href="javascript:void(0);"
                          ...
                          <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/8.jpg" data-image="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/8.jpg" alt="Nike
                  ...
                  <div class="product-image-detail box__product-gallery
                    ...
                    <ul id="sliderproduct" class="site-box-content
                      ...
                      <li class="product-gallery-item gallery-item
                        current " id="imgg1a">
                        <img class="product-image-feature " src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/1.jpg"
                          alt="Nike Air Max 90 Essential" grape="">
                      </li>

                      <li class="product-gallery-item gallery-item " id="imgg2a">
                        <img class="product-image-feature" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/5.jpg"
                          alt="Nike Air Max 90 Essential" grape="">
                      </li>

                      <li class="product-gallery-item gallery-item " id="imgg3a">
                        <img class="product-image-feature" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/2.jpg"
                          alt="Nike Air Max 90 Essential" grape="">
                      </li>

                      <li class="product-gallery-item gallery-ite " id="imgg4a">
                        <img class="product-image-feature" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/4.jpg"
                          alt="Nike Air Max 90 Essential" grape="">
                      </li>

                      <li class="product-gallery-item gallery-item " id="imgg5a">
                        <img class="product-image-feature" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/7.jpg"
                          alt="Nike Air Max 90 Essential" grape="">
                      </li>

                      <li class="product-gallery-item gallery-item " id="imgg6a">
                        <img class="product-image-feature" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/3.jpg"
                          alt="Nike Air Max 90 Essential" grape="">
                      </li>

                      <li class="product-gallery-item gallery-item " id="imgg7a">
                        <img class="product-image-feature" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/8.jpg"
                          alt="Nike Air Max 90 Essential" grape="">
                      </li>

                      <li class="product-gallery-item gallery-item " id="imgg8a">
                        <img class="product-image-feature" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/6.jpg"
                          alt="Nike Air Max 90 Essential" grape="">
                      </li>
                  ...
                  <div class="product-block">
                    <div class="product-img fade-box">
                      <a href="#" title="Adidas EQT Cushion ADV" class="img-resize">
                        <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/shoes/800502_01_e92c3b2bb8764b52a791846d84a3a360_grande.jpg"
                          alt="Adidas EQT Cushion ADV" class="lazyloaded">
                        <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/shoes/shoes fade 1.jpg" alt="Adidas EQT Cushion ADV" class="lazyloaded">
                      </a>
                  ...
                  <div class="product-block">
                    <div class="product-img fade-box">
                      <a href="#" title="Adidas Nmd R1" class="img-resize">
                        <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/shoes/201493_1_017364c87c3e4802a8cda5259e3d5a95_grande.jpg" alt="Adidas Nmd R1"
                          class="lazyloaded">
                        <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/shoes/shoes fade 2.jpg" alt="Adidas Nmd R1" class="lazyloaded">
                      </a>
                  ...
                  <div class="product-block">
                    <div class="product-img fade-box">
                      <a href="#" title="Adidas PW Solar HU NMD" class="img-resize">
                        <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/shoes/805266_02_b8b2cdd1782246febf8879a44a7e5021_grande.jpg"
                          alt="Adidas PW Solar HU NMD" class="lazyloaded">
                        <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/shoes/shoes fade 3.jpg" alt="Adidas PW Solar HU NMD" class="lazyloaded">
                      </a>
                  ...
                  <div class="product-block">
                    <div class="product-img fade-box">
                      <a href="#" title="Adidas Ultraboost W" class="img-resize">
                        <img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/shoes/801432_01_b16d089f8bda434bacfe4620e8480be1_grande.jpg"
    ...
    <div class="product-zoom11">
     <div class="product-zom">
      ...
      <div class="owl-carousel owl-theme owl-product1">
        ...
        <div class="item"><img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/1.jpg" alt="">
        </div>
        <div class="item"><img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/2.jpg" alt="">
        </div>
        <div class="item"><img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/3.jpg" alt="">
        </div>
        <div class="item"><img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/4.jpg" alt="">
        </div>
        <div class="item"><img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/5.jpg" alt="">
        </div>
        <div class="item"><img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/6.jpg" alt="">
        </div>
        <div class="item"><img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/7.jpg" alt="">
        </div>
        <div class="item"><img src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/images/detailproduct/8.jpg" alt="">
        </div>
